...
* Introduction
This is my the configuration for exwm, built from scratch with the help of [[https://github.com/daviwil/emacs-from-scratch][System Crafters]].
...
#+begin_src shell :tangle ./exwm/exwm.desktop :mkdirp yes
  ...
  Exec=sh /home/luis/.emacs.d/exwm/start-exwm.sh
  TryExec=sh
  Type=Application
