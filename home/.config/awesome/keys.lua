...
globalkeys = gears.table.join(
    awful.key({ modkey, shiftkey }, "F1", hotkeys_popup.show_help,
    ...
    awful.key({ modkey, "Control" }, "Escape", quitmenu.show,
    ...
    awful.key({ modkey, "Shift" }, "d", function() awful.spawn("rofi -show 'run'") end,
        { description = "Open binary launcher", group = "launcher" }),
    ...
    awful.key({ modkey, }, "F1", function() awful.layout.set(awful.layout.suit.tile) end,
        { description = "set layout to stack", group = "layout" }),
    awful.key({ modkey, }, "F2", function() awful.layout.set(awful.layout.suit.tile.bottom) end,
        { description = "set layout to stack bottom", group = "layout" }),
    awful.key({ modkey, }, "F3", function() awful.layout.set(awful.layout.suit.max) end,
