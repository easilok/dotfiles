...
local function emit_volume_info()
    -- Get volume info
    awful.spawn.easy_async_with_shell("get-volume --out-mute;get-volume --out-volume",
        function(stdout)
...
local function emit_microphone_info()
    ...
    awful.spawn.easy_async_with_shell("get-volume --mic-mute",
        function(stdout)
...
local microphone_script = [[
  bash -c '
    get-volume --mic-subscribe
  ']]

-- Kill old pactl subscribe processes
awful.spawn.easy_async_with_shell("ps x | grep \"get-volume\" | grep -v grep | awk '{print $1}' | xargs kill", function ()
